...
public class BS_GOS1_E2EScripts extends BaseClass
{
	

	String MasterFile = "GOS1_BS_Master.xml";
	String MainFile = "BSGOS1XMLFILEDATA.xlsx";
	...
	public void OPT_GOS1_BS_VR_22(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_VR_22";
		int i = 1;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_3(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_3";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_67(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_67";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_61(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_61";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_63(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_63";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_8(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_8";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_10(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_10";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_18(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_18";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_23(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_23";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_27(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_27";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_38(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_38";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_39(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_BR_39";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_EC_72(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_BS_EC_72";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_BS_BR_39_Statement(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
	...
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void processAllBSGOS1Messages(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException, ParserConfigurationException, SAXException, TransformerException
	{
		...
		//Arrays.asList("OPT_GOS1_BS_VR_22","OPT_GOS1_BS_BR_3");
		...
		for(int j=0;j<keys.size();j += size){
			...
			softAssert.assertEquals(postCode.equalsIgnoreCase("200"),true,"File has not been successfully posted to a Web service for BSGOS1");
		}
