...
public class PMS_GOS1_E2EScripts extends BaseClass
{
	

	String MasterFile = "GOS1_PMS_Master.xml";
	String MainFile = "PMSGOS1XMLFILEDATA.xlsx";
	/****************************************************************
	 * TC_GOS1_BS_Patient_under_16 - To verify E2E flow for GOS1 BS 
	...
	public void GOS1_PMS_XML_VR_078 (String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_078";
		int i = 1;
		...
		//helpers.CommonFunctions.copyFile(MasterFile, key);
		...
		//objXMLhelpers = objXMLhelpers.BSXMLProcess_GOS156(MainFile,XMLType,key, evidence, environment);
	...
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_1 (String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_5_1";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_2(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_5_2";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_3(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_5_3";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_4(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_5_4";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_5(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_5_5";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_5_1_Statement (String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		...
		if(objXMLhelpers.Process)
		{
			...
			if(JobRun)
			{
				...
				//String claimNo="ADA00442";//,ADA00480
				objOPHelpersStatement= objOPHelpersStatement.verifyEntryInStatement(getDriver(),environment,evidence,key,claimNo,"GOS1");
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_23_1(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_23_1";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_EC_23_2(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_EC_23_2";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_064(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_064";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_081(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_081";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_085(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_085";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_090(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_090";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_BR_35(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_BR_35";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_058(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_058";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_065(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_065";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS1_XML_VR_062(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS1_XML_VR_062";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		/*String expectedItemValue = null;*/
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void processAllPMSGOS1Messages(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException, ParserConfigurationException, SAXException, TransformerException
	{
		String allClaimFile= ExcelUtilities.getKeyValueByPosition(MainFile, "XML", "PMSAllClaims", "FILE NAME");
		...
		//Arrays.asList("OPT_GOS1_XML_EC_5_1","OPT_GOS1_XML_EC_5_2","OPT_GOS1_XML_EC_5_3","OPT_GOS1_XML_EC_5_4","OPT_GOS1_XML_EC_5_5");
		for(int keyIndex=0;keyIndex<keys.size();keyIndex++){
			String key= keys.get(keyIndex);
			if(!key.equalsIgnoreCase("PMSAllClaims")){
				temp.add(key);
			}
		}
		keys=temp;
		...
		for(int j=0;j<keys.size();j += size){
			...
			//Akshay S: Added to create xml file during run time for each set of claim message
	        tempCount= tempCount+1;
			allClaimFile= ExcelUtilities.getKeyValueByPosition(MainFile, "XML", "PMSAllClaims", "FILE NAME");
			...
			XMLhelpers objXMLhelpersUpdateMasterData = new XMLhelpers(Process, assertMessage);
			objXMLhelpersUpdateMasterData = objXMLhelpersUpdateMasterData.BULKXMLUpdateMasterAttribute(MainFile,environment, allClaimFile, XMLType,"PMSAllClaims");
			if(objXMLhelpersUpdateMasterData.Process)
			{
				for(String AssetMessage : objXMLhelpersUpdateMasterData.AssetMessage)
				{
					setAssertMessage(AssetMessage+" for key "+"PMSAllClaims", i);
					i = i + 1;
				}
				setAssertMessage("****************************************************************************", i);
			}
			Assert.assertTrue((objXMLhelpersUpdateMasterData.Process), "The Master Data is not updated Sucessfully for key: "+"PMSAllClaims");
			for(int index=0;index<sublist.size();index++){
				...
				if(objXMLhelpersUpdateMasterData.Process)
				{
					...
					setAssertMessage("****************************************************************************", i);
					XMLhelpers.BULKXMLProcess_GOS156_UpdateXML(XMLType,key, evidence, environment,MainFile);
					XMLhelpers.readAndSaveXMLAttributeValues(key,MainFile,"ExpectedValues","GetAttributeDetails","GetChildTagAttributeDetails");
			...
			String Responsecode = helpers.PostXML.BULKgetResultCodeByPostXML(allClaimFile,"PMSAllClaims", environment,MainFile);
			String postCode= ExcelUtilities.getKeyValueByPosition(MainFile, "XML", "PMSAllClaims", "ResponseCodeFromPost");
			if(postCode.equalsIgnoreCase("200")){
				for(int index=0;index<sublist.size();index++){
					String key= sublist.get(index);
					objXMLhelpers= objXMLhelpers.BULKXMLProcess_GOS156_verifyStagingStatus(key,environment,MainFile,Responsecode);
					if(objXMLhelpers.Process)
					{
						for(String AssetMessage : objXMLhelpers.AssetMessage)
						{
			...
			softAssert.assertEquals(postCode.equalsIgnoreCase("200"),true,"File has not been successfully posted to a Web service for PMSGOS1");
		}
		...
		if(JobRun){
			...
			softAssert.assertEquals((!stgVerifiedKeys.isEmpty()&&stgVerifiedKeys!=null),true,"Staging DB verification has failed for all PMS messages");
		}
