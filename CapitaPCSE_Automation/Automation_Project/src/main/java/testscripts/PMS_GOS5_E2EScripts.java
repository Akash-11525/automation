...
/*import reporting.CustomTestNGReport;*/


@Listeners(ListenerClass.class)
/*@Listeners(CustomTestNGReport.class)*/
public class PMS_GOS5_E2EScripts extends BaseClass
{
	

	String MasterFile = "GOS5_PMS_Master.xml";
	String MainFile = "PMSGOS5XMLFILEDATA.xlsx";
	...
	public void OPT_GOS5_XML_VR_034(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_VR_034";
		int i = 1;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_33(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_33";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_11(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_11";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_29(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_29";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_19(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_19";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_VR_034_Statement(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_21(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_21";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_VR_048(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_VR_048";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_VR_048_C1(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_VR_048_C1";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_VR_048_C2(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_VR_048_C2";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Test(retryAnalyzer = helpers.RetryMechanism.class, groups = { "PCSE","XML","Sanity","Regression","CLONE","CloneSanity","RegressionNewEnv"} )
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void OPT_GOS5_XML_BR_11_C2(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException
	{
		
		String key = "OPT_GOS5_XML_BR_11_C2";
		int i = 1;
		boolean Process = false;
		boolean JobRun = false;
		List<String> assertMessage = null;
	...
	@Parameters({"browser", "environment", "clientName","evidence"})
	public void processAllPMSGOS5Messages(String browser ,String environment, String clientName , boolean evidence) throws InterruptedException, IOException, AWTException, ParseException, SQLException, ParserConfigurationException, SAXException, TransformerException
	{
		...
		for(int j=0;j<keys.size();j += size){
			...
			boolean allTagsDeleted= XMLhelpers.copyAndRemoveSampleTagFromXML(MainFile, MasterFile, allClaimFile, "OPT_GOS5_XML_BR_33","Claim-Message");
			...
			softAssert.assertEquals(postCode.equalsIgnoreCase("200"),true,"File has not been successfully posted to a Web service for PMSGOS5");
		}
