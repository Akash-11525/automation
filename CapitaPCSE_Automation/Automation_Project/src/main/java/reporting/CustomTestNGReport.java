...
public class CustomTestNGReport implements IReporter {
	...
	private static final String emailableReportTemplateFile = System.getProperty("user.dir") + "/Upload/Customize-Emailable-Report.html";
	...
	private String getTestMethodReport(String testName, IResultMap testResultMap, boolean passedReault, boolean skippedResult)
	{
		...
		for(ITestResult testResult : testResultSet)
		{
			...
			for(Object paramObj : paramObjArr)
			{
				...
				{
					paramObj = String.valueOf(paramObj);
				}
